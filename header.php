        ...
        <div class="container header-nav-small">
            ...
            <div class="header-actions-small">
                <?php if (isset($_SESSION['nombre'])): ?>
                    ...
                    <a href="/PHP/historial.php" class="historial-link" title="Mis pedidos">
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>
                        </svg>
                    </a>
                    <a href="/PHP/cart.php" class="cart-link" title="Carrito">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="cart-icon">
                            <circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/>
                            <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/>
                        </svg>
                        <span class="cart-badge" style="display:<?= $cart_count > 0 ? 'flex' : 'none' ?>"><?= $cart_count ?></span>
                    </a>
